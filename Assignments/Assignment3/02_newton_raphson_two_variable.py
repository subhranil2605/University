...
if __name__ == '__main__':
    ...
    print(f"Approximate value of x: {round(root[0, 0], 6)}")            # first row, first column: x value
    print(f"Approximate value of y: {round(root[1, 0], 6)}")            # second row, first column: y value
    ...
    plt.savefig('Newton_Raphson_two_variable.jpeg')
    plt.show()
